    ...
    [
      ...
      for (i, (select, cast)) in enumerate(
        [
          ...
          (lambda meta: meta.development, lambda c: c.as_boolean()),
          (lambda meta: meta.GetFieldOrNone("development"), lambda c: c.as_boolean()),
          (lambda meta: meta.HasField("development"), None),
          (lambda meta: meta.force_hitandrun_sampling, lambda c: c.as_boolean()),
          (lambda meta: meta.GetFieldOrNone("force_hitandrun_sampling"), lambda c: c.as_boolean()),
          ...
          (lambda meta: meta.importance_maps[""].importances["param1"].importance, lambda c: c.as_numeric()),
    ...
    [
      ...
      for (i, (select, cast)) in enumerate(
        [
          ...
          (lambda meta: meta.all_parameters_unsorted[0].name, lambda c: c.as_string()),
          (lambda meta: meta.all_parameters_unsorted[0].bounds, None),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.minimum, lambda c: c.as_numeric()),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.GetFieldOrNone("minimum"), lambda c: c.as_numeric()),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.HasField("minimum"), None),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.maximum, lambda c: c.as_numeric()),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.GetFieldOrNone("maximum"), lambda c: c.as_numeric()),
          (lambda meta: meta.all_parameters_unsorted[0].bounds.HasField("maximum"), None),
          (lambda meta: meta.conditionals[0], None),
          (lambda meta: meta.conditionals[0].name, lambda c: c.as_string()),
          (lambda meta: meta.conditionals[0].GetFieldOrNone("name"), lambda c: c.as_string()),
          ...
          (lambda meta: meta.conditionals[0].values[0].name, lambda c: c.as_string()),
          (lambda meta: meta.conditionals[0].values[0].GetFieldOrNone("name"), lambda c: c.as_string()),
