...
class TestStrings:
  def test_is_string(self):
    ...
    assert is_string(numpy.int32(1)) is False
    assert is_string(numpy.int64(1)) is False
    ...
    assert is_string(numpy.float32(1.0)) is False
    assert is_string(numpy.float64(1.0)) is False
  ...
  def is_serial(self):
    ...
    assert is_serial(numpy.int32(1)) is False
    assert is_serial(numpy.int64(1)) is False
    ...
    assert is_serial(numpy.float32(1.0)) is False
    assert is_serial(numpy.float64(1.0)) is False
