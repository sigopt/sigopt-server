...
"""Constants for calling libsigopt.compute; e.g., tolerances, variance, etc."""
...
# Scale = 0.01 means behavior returns to the prior quickly and libsigopt.compute will want to
