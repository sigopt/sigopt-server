...
class CheckpointService(Service):
  def insert_checkpoints(self, checkpoints):
  ...
  def find_by_ids(self, checkpoint_ids):
  ...
  def find_by_training_run_id(self, training_run_id):
    query = (
  ...
  def count_by_training_run(self, training_run_id):
  ...
  def count_by_training_run_ids(self, training_run_ids):
    return dict(
