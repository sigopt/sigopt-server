...
class SuggestionService(Service):
  ...
  def find_by_id(self, suggestion_id: int, deleted: DeleteClause = DeleteClause.NOT_DELETED) -> Suggestion | None:
    """
        suggestion_id is the id of a processed suggestion
        """
    return list_get(self.find_by_ids([suggestion_id], deleted), 0)

  def find_by_ids(self, suggestion_ids, deleted=DeleteClause.NOT_DELETED) -> Sequence[Suggestion]:
    """
        suggestion_id is the id of a processed suggestion
        """
  ...
  def find_by_experiment(
    self, experiment: Experiment, deleted: DeleteClause = DeleteClause.NOT_DELETED
  ) -> Sequence[Suggestion]:
  ...
  def find_open_by_experiment(
    self, experiment: Experiment, deleted: DeleteClause | bool = False
  ...
  def get_suggestions_set_observations(
    self, objects: Sequence[tuple[ProcessedSuggestion, UnprocessedSuggestion]]
  ) -> Sequence[Suggestion]:
    suggestions = [
      Suggestion(
        processed=processed,
  ...
  def count_by_experiment(self, experiment: Experiment, deleted: DeleteClause | bool = DeleteClause.NOT_DELETED) -> int:
  ...
  def count_open_by_experiment(
    self, experiment: Experiment, deleted: DeleteClause | bool = DeleteClause.NOT_DELETED
  ) -> int:
