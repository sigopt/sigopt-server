...
def compact_mapping(dct: Mapping[lists_GHashable, Optional[lists_T]]) -> dict[lists_GHashable, lists_T]:
...
@deal.post(all)
def compact_sequence(lis: Sequence[Optional[lists_T]]) -> list[lists_T]:
