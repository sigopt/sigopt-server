...
from sigoptcompute.covariance import C2RadialMatern, C4RadialMatern, SquareExponential
...
from sigoptcompute.optimization_auxiliary import DEFAULT_SLSQP_PARAMETERS
